# Kavya Udalagama – Portfolio Website
...
## Featured Work
- Hospitality websites (eBeyonds)
- Full-stack web applications
- Data-driven and API-based projects

## Tech Stack
- HTML, CSS, JavaScript
- Angular, React (projects)
- Node.js / .NET (projects)
...
Built with ❤️ and a passion for solving real-world problems
